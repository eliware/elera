export function createHealthService({ db, timeoutMs, log, elera = true }) {
  ...
  async function fetchStatus() {
    ...
    const ready = !elera || (values.wsrep_local_state_comment === 'Synced' && values.wsrep_ready === 'ON' && values.wsrep_cluster_status === 'Primary');
