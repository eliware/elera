...
export async function handleClusterRoute({ method, path, request, response, url, getStatus, bootstrap, lifecycle, getConfig, coldBootstrap, coldEvidence, coldBootstrapLocal, internal = false }) {
