...
export function createControlApi({ db, getStatus, getTraffic, setDrain, bootstrap, lifecycle, getConfig, getActiveIntent, leaseCredentials, routingBundles, routingEvent, metadata, managed, reconciler, artifactStore, observations = [], observationStore, environment = process.env, log, dataDir = environment.MARIADB_DATA_DIR ?? '/var/lib/mysql' }) {
