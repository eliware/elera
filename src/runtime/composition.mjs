...
export function createSupervisorComposition({ environment = process.env, log, query, optionalQuery = query } = {}) {
  ...
  const managed = createManagedMetadata({ query, credentialKey: environment.ELERA_CREDENTIAL_KEY });
