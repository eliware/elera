...
export function createSupervisorControlComposition({ db, metadata, managed, applications, reconciler, artifactStore, routingBundles, routingEvent, recovery, observationStore, health, clusterDrain, lifecycle, telemetry, config, intentState, coldState, getColdRecoveryProtocol: liveColdRecoveryProtocol, processController, applyIntent, log, environment = process.env } = {}) {
