...
export async function resolveExplicitSupervisorStartup({ environment = process.env, nodeName, dataDir, args, joinAddress, decision = explicitStartupDecision, promote = promoteSafeToBootstrap, pathExists = access, addArguments = startupArguments, log = {} } = {}) {
