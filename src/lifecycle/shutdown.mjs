export function createShutdown({ lifecycle, sqlQuiesce, drain, propagateDrain = async () => {}, shutdownCondition, getTimers = () => [], routingBus, routingStream, telemetry, servers = [], closeServer = async () => {}, getMariaProcess = () => undefined, getDb = () => undefined, shutdownTimeoutMs = 60000, quiesceTimeoutMs = 30000, errors, log = {} } = {}) {
