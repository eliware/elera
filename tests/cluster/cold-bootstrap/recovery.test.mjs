...
test('rejects malformed and non-integer recovered sequence numbers', () => { expect(() => parseRecoveredPosition('Recovered position: abc:not-a-number')).toThrow('did not report'); expect(() => parseRecoveredPosition('Recovered position: abc:-1.5')).toThrow('invalid seqno'); });
