...
test('emits a bundle accepted by galera-lib', () => { const bundle = connectionBundleFromConfig({ database: 'app', identity: 'runtime', username: 'app', password: 'secret', routes, expiresAt: '2099-01-01T00:00:00Z' }); expect(validateBundle(bundle)).toBe(bundle); });
