...
test('prefers the explicitly configured runtime node name', () => { expect(runtimeIdentity({ name: 'elera-1', hostname: () => 'elera-0', addresses: () => ({ eth0: [{ address: '10.0.0.1', family: 'IPv4', internal: false }] }) })).toEqual({ name: 'elera-1', address: '10.0.0.1' }); });
