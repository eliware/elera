...
test('delegates route inspection to the observation and decision policies', async () => {
  ...
  await expect(handleRoutingInspection({ url: new URL('http://localhost/api/v1/routes?application=app'), response, identity, observationStore: { snapshot: () => observations }, getStatus: async () => ({ ready: true }), environment: {} })).resolves.toBe(true);
