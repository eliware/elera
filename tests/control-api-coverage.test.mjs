...
test('handles authentication, unavailable services, and request errors', async () => {
  ...
  const makeApi = (overrides = {}) => createControlApi({
    ...
    leaseCredentials: undefined, managed: undefined, environment: { ROOT_TOKEN: 'root', ELERA: '0' },
