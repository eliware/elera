...
test('defines a credential-free topology event fixture accepted by elera-lib', () => { expect(fixture.type).toBe('routing.topology'); expect(fixture.version).toBeGreaterThan(0); expect(fixture.context.ports.sql).toBe(3306); expect(fixture).not.toHaveProperty('credentials'); expect(validateRoutingEvent(fixture)).toEqual(fixture); });
